...
## 2026-08-12 실제 당일 운영 순서 정정

Source: Telegram `동아잇일보`, Jiwoong Kim correction, 2026-08-12.

| 시간 | 대상 | 메모 |
|---|---|---|
| 09:00-13:00 | 초등 3·4학년 | 오전 회차 |
| 13:00-14:00 | 전체 | 점심 |
| 14:00-18:00 | 초등 5·6학년 | 오후 회차 |

> [!important] 실제 시간 순서
> 이전 설문/커리큘럼 문서의 `1st 13명 / 2nd 10명`, `A=5·6학년 / B=3·4학년` 표기는 실제 당일 시간 순서로 해석하지 않는다. 실제 운영 순서는 **초3·4 오전 → 전체 점심 → 초5·6 오후**다.
...
> [!note] 이 견적서가 9/15 덱 숫자의 정본이다 (2026-09-05)
> 후속 문서들이 기획 검토가(가족당 40~60만원)를 계속 인용해 왔다. 실적값은 **가족당 92만원**이며, 여기서 "시간당 10만→20만"의 단위가 **1인 기준**임도 풀린다. 원가·정산 구조 분석: [[ir-20260915-pricing-evidence-audit]]
